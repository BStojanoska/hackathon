...
function ProfileSettings(){
        ...
        <>
           ...
           <div className="grid grid:gd-cols-1 grid-cols-2 gap-6">
            ...
            <div className = "w-full md:w-auto">
                ...
                <div class="chat chat-start">
                    ...
                    <div class="chat-bubble chat-bubble-primary">Супер дечко, ептен се труди!</div>
                    </div>
                    <div class="chat chat-start">
                    <div class="chat-image avatar">
                        <div class="w-10 rounded-full">
                    ...
                    <div class="chat-bubble chat-bubble-secondary">Да, кај нас заврши 3 курсеви!</div>
                    </div>
                    <div class="chat chat-start">
                    <div class="chat-image avatar">
                        <div class="w-10 rounded-full">
                    ...
                    <div class="chat-bubble chat-bubble-accent">Денес му понудија работа!</div>
                    </div>
           </div>   
           ...
           <div role="tabpanel" className="tab-content bg-base-100 border-base-300 rounded-box p-6">
            ...
            <ul className="steps steps-vertical">
             <li className="step step-success">Изучување основни компјутерски вештини</li>
             <li className="step step-success">Изучување основи на Word</li>
           ...
           <ul class="menu bg-base-200 w-56 rounded-box">
                <li>
                    <a>
                    <svg class="w-5 h-5 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 1v16M1 9h16"/>
                ...
                <li>
                    <a>
                    <svg class="w-5 h-5 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 21 21">
